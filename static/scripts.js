...
function addMarker(place)
{
    ...
    var marker = new google.maps.Marker({
        ...
        icon:{labelOrigin:new google.maps.Point(16,40),url:"https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png"}
    });
    
    // set parameter which will be passed to articles (application.py)
    var parameters = {
...
{
    // iterate over markers, remove all markers from the map and delete them 
